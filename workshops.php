  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav navbar navbar-tabs">
					<li class="dropdown">
					  <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><?php /*if(isset($_SESSION['sess_user'])) echo $_SESSION['sess_user']; */echo'username';?><span class="caret"></span></a>
