...
$con=mysqli_connect("localhost","root","","tutoring_portal") or die("error connecting to mysql ".mysqli_error($con));
	...
	function login()
{
	...
	function register_user(){
        ...
        <a class="btn btn-primary" href="index.html" role="button">Continue to login</a>
